...
Menu::Menu(int width, int height)
{
    ...
    tmpW = this->width / 2;
    tmpH = this->height / 2;
    this->option[MENU_SINGLEPLAYER] = new MenuOption(tmpW - 25, 200, 50, 50);
    this->option[MENU_OPTIONS] = new MenuOption(tmpW - 225, 150, 50, 50);
    this->option[MENU_EXIT] = new MenuOption(tmpW + 200, 150, 50, 50);
